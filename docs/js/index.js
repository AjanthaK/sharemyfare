...
function displayVictoryMess(moves) {
  document.getElementById("moves").innerHTML = "You walked " + moves + " steps to find the boy...";
...
window.onload = function() {
  ...
  sprite = new Image();
  sprite.src =
    "https://raw.githubusercontent.com/AjanthaK/sharemyfare/main/docs/img/start.png" +
    "?" +
    new Date().getTime();
  ...
  finishSprite.src = "https://raw.githubusercontent.com/AjanthaK/sharemyfare/main/docs/img/end.png"+
  "?" +
  new Date().getTime();
